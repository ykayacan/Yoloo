...
import static com.yoloo.android.notificationhandler.NotificationConstants.KEY_COMMENT;
...
public final class MentionNotification implements NotificationProvider {
  ...
  public MentionNotification(Map<String, String> data, Context context,
  ...
  public Notification getNotification() {
    String notificationContent = context
        .getResources()
        .getString(R.string.label_notification_mention, data.get(KEY_SENDER_USERNAME),

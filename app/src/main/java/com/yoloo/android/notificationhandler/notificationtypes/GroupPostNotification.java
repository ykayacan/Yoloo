...
public final class GroupPostNotification implements NotificationProvider {

  private final NotificationResponse response;
  private final Context context;

  public GroupPostNotification(NotificationResponse response, Context context) {
  ...
  @Override public Notification getNotification() {
    ...
    String content = context
        .getResources()
        .getString(R.string.label_notification_new_group_post, response.getGroupName());

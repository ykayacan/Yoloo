...
public final class Preconditions {
  ...
  /**
   * Ensures the truth from an expression involving one or more parameters to the calling method.
   *
   ...
   * placeholders, the unmatched arguments will be appended to the end from the formatted message in
   * square braces.
   *
  ...
  private static String format(String template, @Nullable Object... args) {
    ...
    // if we run out from placeholders, append the extra args in square braces
    if (i < args.length) {
      builder.append(" [");
      builder.append(args[i++]);
      while (i < args.length) {

package com.yoloo.android.util.glide.transcoder;
...
import com.yoloo.android.util.glide.resource.PaletteBitmapResource;

/**
 * A {@link ResourceTranscoder} for generating
 * {@link Palette}s from {@link Bitmap}s in the background.
 */

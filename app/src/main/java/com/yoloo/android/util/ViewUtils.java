...
public final class ViewUtils {
  ...
  public static void setNavBarTransparent(View view) {
  ...
  /*public static RippleDrawable createRipple(@NonNull Palette palette,
      ...
      @FloatRange(from = 0f, to = 1f) float lightAlpha, @ColorInt int fallbackColor,
      boolean bounded) {
   ...
   */
  public static float getSingleLineTextSize(String text, TextPaint paint, float targetWidth,

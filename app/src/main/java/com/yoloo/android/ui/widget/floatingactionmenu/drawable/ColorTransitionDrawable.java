...
package com.yoloo.android.ui.widget.floatingactionmenu.drawable;
...
import com.yoloo.android.ui.widget.floatingactionmenu.animation.AnimationUtils;
import com.yoloo.android.ui.widget.floatingactionmenu.animation.ValueAnimatorCompat;
...
public class ColorTransitionDrawable extends Drawable {
  ...
  private Interpolator mStartInterpolator = AnimUtils.getLinearInterpolator();
  ...
  public ColorTransitionDrawable(@ColorInt int start, @ColorInt int end) {
    ...
    mAnimator.setUpdateListener(animator -> setColorRatio(animator.getAnimatedFloatValue()));
  }

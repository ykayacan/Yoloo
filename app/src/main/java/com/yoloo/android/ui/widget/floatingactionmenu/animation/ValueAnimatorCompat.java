...
package com.yoloo.android.ui.widget.floatingactionmenu.animation;

import android.view.animation.Interpolator;

/**
 * This class offers a very small subset of {@code ValueAnimator}'s API, but works pre-v11 too. <p>
 * You shouldn't not instantiate this directly. Instead use {@code ViewUtils.createAnimator()}.
 */
public class ValueAnimatorCompat {
  /**
   * This value is used with the {@link #setRepeatCount(int)} property to repeat the animation
   * indefinitely.
   */
  ...
  public interface AnimatorUpdateListener {
    /**
     * <p>Notifies the occurrence getPost another frame getPost the animation.</p>
     *

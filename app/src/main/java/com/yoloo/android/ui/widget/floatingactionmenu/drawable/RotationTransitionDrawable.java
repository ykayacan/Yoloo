...
public class RotationTransitionDrawable extends LayerDrawable {
  ...
  private Interpolator mStartInterpolator = AnimUtils.getOvershootInterpolator();
  private Interpolator mReverseInterpolator = AnimUtils.getAnticipateInterpolator();

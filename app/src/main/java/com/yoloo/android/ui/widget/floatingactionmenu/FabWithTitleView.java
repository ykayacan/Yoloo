...
final class FabWithTitleView extends LinearLayout {
  ...
  private void init(Context context, AttributeSet attrs) {
    init(context);
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FabWithTitleView, 0, 0);
  ...
  private void init(Context context) {
    ...
    LayoutParams layoutParams =
        new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, FabWithOptions.pxToDp(context, 56));

package com.yoloo.android.ui.widget.materialbadge;
...
public class MaterialBadgeTextView extends AppCompatTextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    backgroundColor =
        typedArray.getColor(R.styleable.MaterialBadgeTextView_mbtv_backgroundColor, Color.WHITE);
    borderColor =
  ...
  @SuppressLint("SetTextI18n") public void setBadgeCount(int count, boolean goneWhenZero) {
    if (count > 0 && count <= 99) {

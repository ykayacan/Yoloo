...
public class CircleIndicator extends LinearLayout {
  ...
  private void checkIndicatorConfig(Context context) {
    indicatorWidth =
        (indicatorWidth < 0) ? DisplayUtil.dpToPx(DEFAULT_INDICATOR_WIDTH) : indicatorWidth;
    indicatorHeight =
        (indicatorHeight < 0) ? DisplayUtil.dpToPx(DEFAULT_INDICATOR_WIDTH) : indicatorHeight;
    indicatorMargin =
        (indicatorMargin < 0) ? DisplayUtil.dpToPx(DEFAULT_INDICATOR_WIDTH) : indicatorMargin;
    ...
    indicatorBackgroundResId =
        (indicatorBackgroundResId == 0) ? R.drawable.white_radius : indicatorBackgroundResId;

...
class LinkableMovementMethod extends LinkMovementMethod {

  private static final String LINKABLE_BASE_SCHEME =
      "https://github.com/fobid/linkable-text-android";
  static final String LINKABLE_HASHTAG_SCHEME = LINKABLE_BASE_SCHEME + "/hashtag";
  static final String LINKABLE_MENTION_SCHEME = LINKABLE_BASE_SCHEME + "/mention";
  static final String LINKABLE_IP_ADDRESS_SCHEME = LINKABLE_BASE_SCHEME + "/ip";

  private final LinkableCallback linkableCallback;

  LinkableMovementMethod(LinkableCallback linkableCallback) {
    super();

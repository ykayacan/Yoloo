...
public abstract class TrendingBlogModel
  ...
  @Override public void bind(TrendingBlogHolder holder) {
    super.bind(holder);
    ...
    holder.ibOptions.setVisibility(post.isOwner() ? View.GONE : View.VISIBLE);
  ...
  @Override public void unbind(TrendingBlogHolder holder) {
    super.unbind(holder);

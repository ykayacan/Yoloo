...
class ComposePresenter extends MvpPresenter<ComposeView> {
  ...
  ComposePresenter(TagRepository tagRepository, PostRepository postRepository) {
    this.tagRepository = tagRepository;
    this.postRepository = postRepository;
  }

  @Override public void onAttachView(ComposeView view) {

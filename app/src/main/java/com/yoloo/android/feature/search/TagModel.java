...
public class TagModel extends EpoxyModelWithHolder<TagModel.TagViewHolder> {
  ...
  @Override
  protected TagViewHolder createNewHolder() {
  ...
  @Override
  public void bind(TagViewHolder holder) {
  ...
  @Override
  public void unbind(TagViewHolder holder) {
  ...
  static class TagViewHolder extends BaseEpoxyHolder {
    ...
    @BindView(R.id.tv_item_search_post_count)
    TextView tvTagCount;
  }
}

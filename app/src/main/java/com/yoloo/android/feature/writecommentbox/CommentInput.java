...
public class CommentInput extends MvpLinearLayout<CommentInputView, CommentInputPresenter>
    implements CommentInputView {
  ...
  public CommentInput(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public CommentInputPresenter createPresenter() {
    return new CommentInputPresenter(UserRepositoryProvider.getRepository(),

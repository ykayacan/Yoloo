...
public class ComposeLayout extends MvpLinearLayout<ComposeLayoutView, ComposeLayoutPresenter>
    implements ComposeLayoutView {
  ...
  public ComposeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    init();
  }

  private void init() {
    final View view = inflate(getContext(), R.layout.layout_send_message, this);
  ...
  @NonNull @Override public ComposeLayoutPresenter createPresenter() {
    return new ComposeLayoutPresenter(

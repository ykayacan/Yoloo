...
public class GroupDetailController extends BaseController implements
    GroupOverviewController.OnGroupClickListener {
  ...
  public static GroupDetailController create() {
    return new GroupDetailController();
  }
  ...
  @Override protected void onViewBound(@NonNull View view) {
    ...
    if (!childRouter.hasRootController()) {
      GroupOverviewController controller = GroupOverviewController.create();
      controller.setOnGroupClickListener(this);
  ...
  @Override public void onGroupClick(View v, GroupRealm category) {
    getRouter().pushController(
        RouterTransaction.with(PostListController.ofGroup(category.getName()))

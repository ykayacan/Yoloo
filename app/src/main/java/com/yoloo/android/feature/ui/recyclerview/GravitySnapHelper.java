...
public class GravitySnapHelper extends LinearSnapHelper {
  ...
  private boolean snapLastItemEnabled;
  ...
  private RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
      ...
      if (newState == RecyclerView.SCROLL_STATE_IDLE && snapping && snapListener != null) {
  ...
  public GravitySnapHelper(int gravity, boolean enableSnapLastItem, SnapListener snapListener) {
    ...
    snapLastItemEnabled = enableSnapLastItem;
  }
  ...
  private View findStartView(RecyclerView.LayoutManager layoutManager,
    ...
    if (layoutManager instanceof LinearLayoutManager) {
      ...
      // If we're at the end of the loadPosts, we shouldn't snap
      ...
      if (visibleWidth > 0.5f && !endOfList) {
        return child;
      } else if (snapLastItemEnabled && endOfList) {
        return child;
      } else if (endOfList) {
        return null;
      } else {
  ...
  private View findEndView(RecyclerView.LayoutManager layoutManager,
    ...
    if (layoutManager instanceof LinearLayoutManager) {
      ...
      // If we're at the start of the loadPosts, we shouldn't snap
      ...
      if (visibleWidth > 0.5f && !startOfList) {
        return child;
      } else if (snapLastItemEnabled && startOfList) {
        return child;
      } else if (startOfList) {
        return null;
      } else {

...
public class HintSpinnerAdapter implements SpinnerAdapter, ListAdapter {
  ...
  /**
   * Use this constructor to have NO 'Select One...' item, instead use the standard prompt or
   * nothing at all.
   *
   * @param spinnerAdapter wrapped Adapter.
   * @param hintLayout layout for nothing selected, perhaps you want text grayed out like a
   * prompt...
   */
  ...
  /**
   * Use this constructor to Define your 'Select One...' layout as the first row in the returned
   * choices. If you do this, you probably don't want a prompt on your spinner or it'll have two
   * 'Select' rows.
   *
   * @param spinnerAdapter wrapped Adapter. Should probably return false for isEnabled(0)
   * @param hintLayout layout for nothing selected, perhaps you want text grayed out like a
   * prompt...
   * @param hintDropdownLayout layout for your 'Select an Item...' in the dropdown.
   */
  public HintSpinnerAdapter(SpinnerAdapter spinnerAdapter, int hintLayout, int hintDropdownLayout,
      Context context) {
  ...
  public final View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (position == 0) {
      final View view = getHintView(parent);
      final TextView title = (TextView) view.findViewById(R.id.spinner_title);
      final TextView subtitle = (TextView) view.findViewById(R.id.spinner_subtitle);
  ...
  /**
   * View to show in Spinner with Nothing Selected Override this to do something dynamic... e.g. "37
   * Options Found"
   */
  ...
  public View getDropDownView(int position, View convertView, ViewGroup parent) {
    ...
    if (position == 0) {
      return hintDropdownLayout == -1 ? new View(context) : getHintDropdownView(parent);
    }

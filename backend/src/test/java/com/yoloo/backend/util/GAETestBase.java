...
abstract class GAETestBase {
  ...
  protected LocalServiceTestHelper helper = new LocalServiceTestHelper(
      ...
      new LocalUserServiceTestConfig(), new LocalURLFetchServiceTestConfig(),
      new LocalTaskQueueTestConfig().setQueueXmlPath("src/main/webapp/WEB-INF/queue.xml"),
      new LocalSearchServiceTestConfig(), new LocalMemcacheServiceTestConfig())
      .setTimeZone(TimeZone.getDefault())
      .setEnvAttributes(
          ImmutableMap.<String, Object>of("com.google.appengine.api.users.UserService.user_id_key",

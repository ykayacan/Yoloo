...
public final class AccountCounterShard {
  ...
  public static Key<AccountCounterShard> createKey(Key<Account> accountKey, int shardId) {
    return Key.create(AccountCounterShard.class, accountKey.toWebSafeString() + ":" + shardId);
  }

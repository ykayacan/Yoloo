...
public final class MediaConfig {
  ...
  public static final String SERVE_CATEGORY_BUCKET = STORAGE_PREFIX + BASE_BUCKET_URL
      + "/categories";
  public static final String SERVE_USER_MEDIAS_BUCKET = STORAGE_PREFIX + BASE_BUCKET_URL
      + "/user-medias";

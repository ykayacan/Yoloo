...
public class MessagesListAdapter<MESSAGE extends IMessage>
  ...
  public void enableSelectionMode(SelectionListener selectionListener) {
    if (selectionListener == null) {
      throw new IllegalArgumentException(
          "SelectionListener must not be null. Use `disableSelectionMode()` if you want tp "
   ...
   */
  public void setOnMessageLongClickListener(OnMessageLongClickListener<MESSAGE>
  ...
  * */
  ...
  /**
   * Interface definition for a callback to be invoked when next part of messages need to be
   * loaded.
   */

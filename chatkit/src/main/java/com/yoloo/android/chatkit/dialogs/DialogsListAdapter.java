...
public class DialogsListAdapter<DIALOG extends IDialog>
  ...
  public BaseDialogViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    try {
      Constructor<? extends BaseDialogViewHolder> constructor = holderClass.getDeclaredConstructor(
          View.class);
  ...
  public static class DialogViewHolder<DIALOG extends IDialog>
    ...
    private void applyStyle() {
      if (dialogStyle != null) {
        ...
        tvLastMessage.setTextSize(TypedValue.COMPLEX_UNIT_PX,
            dialogStyle.getDialogMessageTextSize());
        ...
        tvBubble.setTextSize(TypedValue.COMPLEX_UNIT_PX,
            dialogStyle.getDialogUnreadBubbleTextSize());
    ...
    private void applyDefaultStyle() {
      if (dialogStyle != null) {
        ...
        tvLastMessage.setTypeface(tvLastMessage.getTypeface(),
            dialogStyle.getDialogMessageTextStyle());
      }
    }
    ...
    private void applyUnreadStyle() {
      if (dialogStyle != null) {
        ...
        tvLastMessage.setTypeface(tvLastMessage.getTypeface(),
            dialogStyle.getDialogUnreadMessageTextStyle());
      }
    }
